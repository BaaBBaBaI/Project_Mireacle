Привет! Я подготовил решения для всех четырех заданий из практической работы по созданию пользовательских функций в SQL (на диалекте PostgreSQL, так как синтаксис задания специфичен для этой СУБД).

Ниже представлены SQL-скрипты для каждой функции с комментариями.
