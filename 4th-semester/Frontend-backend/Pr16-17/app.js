...
socket.on('taskAdded', (task) => {
    ...
    notification.style.cssText = `
        ...
        padding: 1rem; border-radius: 5px; z-index: 1000;
    `;
...
async function subscribeToPush() {
    ...
    try {
        ...
        const subscription = await registration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BF6ICWGSo0P3dpewUlWzopZ2BxcvuHqmTz89_h5AzLShldHJH8Ttze542Fw_byE6ymCiXPnz12PO0FupeX8H0TM')
        });
            ...
            if (enableBtn && disableBtn) {
                ...
                enableBtn.addEventListener('click', async () => {
                    ...
                    if (permission === 'granted') {
                        ...
                        enableBtn.style.display = 'none';
                        disableBtn.style.display = 'inline-block';
                    } else { alert('Необходимо разрешить уведомления.'); }
                });
